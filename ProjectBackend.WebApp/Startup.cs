...
namespace ProjectBackend.WebApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDefaultIdentity<IdentityUser>(options => options.SignIn.RequireConfirmedAccount = false).AddRoles<IdentityRole>().AddEntityFrameworkStores<QuizAppContext>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, RoleManager<IdentityRole> roleMgr, UserManager<IdentityUser> userMgr)
        {
            ...
            QuizAppContextExtensions.SeedRoles(roleMgr).Wait();
            //QuizAppContextExtensions.SeedUsers(userMgr).Wait();
        }
    }
}
